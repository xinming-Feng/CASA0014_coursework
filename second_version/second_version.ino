...
void sendmqtt(float temperature, float humidity){
    ...
    //Try to change only the RGB single channel color to make the color change obvious
    int R = 0, G = 0, B = 0, W = 50;
    if (temperature > 20) {
        R = cv.R;
    ...
    for (int i = ID_START; i <= ID_END/2; i++) {
        sprintf(mqtt_message_1, "{\"pixelid\": %d, \"R\": %d, \"G\": %d, \"B\": %d, \"W\": %d}, ", i, R, G, B, W);
        sprintf(mqtt_message_2, "{\"pixelid\": %d, \"R\": %d, \"G\": %d, \"B\": %d, \"W\": %d}", ID_END-i , R, G, B, W);
...
//        sprintf(mqtt_message, "{\"pixelid\": %d, \"R\": %d, \"G\": %d, \"B\": %d, \"W\": %d}", i, cv.R, 0, 0, 50);
//        delay(1000);
//
//        Serial.println(mqtt_topic);
...
//  }else if (temperature < 20){
//      for (int i = ID_START; i <= ID_END; i++) {
//        sprintf(mqtt_message, "{\"pixelid\": %d, \"R\": %d, \"G\": %d, \"B\": %d, \"W\": %d}", i, 0, 0, cv.B, 50);
//        delay(1000);
//
//        Serial.println(mqtt_topic);
//        Serial.println(mqtt_message);
...
//    }else {
//       for (int i = ID_START; i <= ID_END; i++) {
//        sprintf(mqtt_message, "{\"pixelid\": %d, \"R\": %d, \"G\": %d, \"B\": %d, \"W\": %d}", i, 0, cv.G, 0, 50);
//        delay(1000);
//
//        Serial.println(mqtt_topic);
//        Serial.println(mqtt_message);
...
//     for (int i = ID_START; i <= ID_END; i++) {
//         sprintf(mqtt_message, "{\"pixelid\": %d, \"R\": %d, \"G\": %d, \"B\": %d, \"W\": %d}", i, cv.R, cv.G, cv.B, 50);
//         delay(1000);
